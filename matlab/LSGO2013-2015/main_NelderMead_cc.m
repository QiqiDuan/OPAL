% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Run Script for *NelderMead_cc.m* on CEC2013-2015 LSGO Benchmark Functions.
%
% ----------
% Reference:
% ----------
...
fun_ind_end = 15;
num_trials = 25;
max_fe = 3 * (10 ^ 5); % vs. max_fe = 3 * (10 ^ 6);
...
for fun_ind = fun_ind_start : fun_ind_end
    ...
    for trial_ind = 1 : num_trials
        ...
        sub = sb(1, fun_ind);
        slb = -sub;
        fp = slb + (sub - slb) .* rand(RandStream('mt19937ar', 'Seed', rsip), ...
                fun_dim(1, fun_ind), fun_dim(1, fun_ind) + 1)';
        [opt_fp(trial_ind, :), opt_fv(trial_ind, 1), run_time(trial_ind, 1), num_fe(trial_ind, 1), fv_seq(trial_ind, :), in_seq(trial_ind, :)] = ...
            NelderMead_cc(fhd, fun_ind, fp, 0, max_fe, interval_fe);
