% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Run Script for comparing CCFR_IDG2 with CCFR_IDG2_CMAES.
%     1. opt_fv [mean + std]
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
...
base_line = 'CCFR_IDG2';
comp_line = 'CCFR_IDG2_CMAES';
load([base_line '.mat']);
load([comp_line '.mat']);
mean_base_line = CCFR_IDG2(:, 1)';
std_base_line = CCFR_IDG2(:, 2)';
mean_comp_line = CCFR_IDG2_CMAES(:, 1)';
std_comp_line = CCFR_IDG2_CMAES(:, 2)';
