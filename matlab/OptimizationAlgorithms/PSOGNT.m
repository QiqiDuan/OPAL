...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Particle Swarm Optimizer With a Global Neighbor Topology [PSOGNT].
%
% -----------------
% || INPUT  || <---
% -----------------
